        ...
        VStack(spacing: 3) {
            HStack(spacing: 3) {
                ForEach(dayLabels.indices, id: \.self) { i in
                    Text(dayLabels[i])
                        .font(.system(size: 7))
                        .foregroundColor(i == bestDayIndex ? Color.trendPositive.opacity(0.7) : .white.opacity(0.20))
                ...
                HStack(spacing: 3) {
                    ForEach(displayWeeks[wi].days.indices, id: \.self) { di in
                        ...
                        RoundedRectangle(cornerRadius: 2)
                            .fill(active
                                  ? (isBest ? Color.trendPositive : Color.white.opacity(0.45))
                    ...
                    HStack(spacing: 4) {
                        ForEach(data.weeks[wi].days.indices, id: \.self) { di in
                            ...
                            RoundedRectangle(cornerRadius: 3)
                                .fill(active
                                      ? (isBest ? Color.trendPositive : Color.white.opacity(0.50))
