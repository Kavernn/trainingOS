    ...
    var body: some View {
        HStack(alignment: .bottom, spacing: 4) {
            ForEach(values.indices, id: \.self) { i in
                ...
                let barColor: Color = isLast ? zone.color : Color.appOnSurface.opacity(0.22)
                VStack(spacing: 3) {
                    ...
                    Text("S\(i + 1)")
                        .font(.system(size: 7))
                        .foregroundColor(Color.appOnSurface.opacity(isLast ? 0.45 : 0.22))
                }
            }
        }
        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            HStack(spacing: 0) {
                ...
                LoadStat(label: "CHARGE CHRONIQUE", sublabel: "28 jours moy.",
                         ...
                         color: Color.appOnSurface.opacity(0.55))
            }
                ...
                HStack(spacing: 0) {
                    if let s = data.strengthAcwr {
                        LoadStat(label: "FORCE", sublabel: "ACWR",
                                 ...
                                 color: Color.appOnSurface.opacity(0.70))
                    }
                    if data.strengthAcwr != nil && data.cardioAcwr != nil {
                        Divider().background(Color.appSurfaceInset).frame(height: 40)
                    }
